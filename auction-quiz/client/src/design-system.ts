...
export const tokens = {
  ...
  shadow: {
    ...
    sm: "0 4px 14px rgba(15,23,42,0.09), 0 1px 3px rgba(15,23,42,0.06)",
    md: "0 8px 24px rgba(15,23,42,0.10), 0 3px 8px rgba(15,23,42,0.06)",
    lg: "0 16px 36px rgba(15,23,42,0.12), 0 6px 12px rgba(15,23,42,0.06)",
    xl: "0 28px 56px rgba(15,23,42,0.14), 0 10px 20px rgba(15,23,42,0.08)",
